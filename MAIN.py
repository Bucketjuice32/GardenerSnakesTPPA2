...
def lookup_info(patient_list):
    ...
    if patient_display(patient_list) == False:
        ...
        if id_name in patient_list: #checks if id name is in the patient list
            print(end='\n')
            print(patient_list[id_name]) #prints the patient info
            print(end='\n')
        else:
        ...
        if id_name in patient_list:
            print(end='\n')
            print(patient_list[id_name]["Procedures:"]) #prints only the procedure of the patient list
            print(end='\n')
        else:
